...
//先初始化IO口
  ...
  ADC_InitStructure.ADC_ScanConvMode = ENABLE;//非扫描模式	 disable单通道 enable多通道！！
  ...
  ADC_Init(ADC1, &ADC_InitStructure);
	...
	//设置指定ADC的规则组通道，一个序列，采样时间
	ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 2, ADC_SampleTime_480Cycles );	//ADC1,ADC通道,480个周期,提高采样时间可以提高精确度			    
